(function() {
    ...
    e = function() {
        ...
        return o.prototype.defaults = {
            ...
            for (n in i = [], e) o = e[n], t["" + n] = o, i.push(function() {
                var e, i, s, a;
                for (a = [], e = 0, i = (s = this.vendors).length; e < i; e++) r = s[e], a.push(t["" + r + n.charAt(0).toUpperCase() + n.substr(1)] = o);
                return a
            }.call(this));
            return i
        }, o.prototype.vendorCSS = function(t, e) {
            var n, o, r, s, a, l;
            for (s = (a = i(t)).getPropertyCSSValue(e), n = 0, o = (r = this.vendors).length; n < o; n++) l = r[n], s = s || a.getPropertyCSSValue("-" + l + "-" + e);
            return s
    ...
    let t, e, n;
    t = $("#submitBtn"), e = $("#submitPopup"), n = $("#contactForm form"), t.on("click", function(t) {
        t.preventDefault(), name && email && phoneNo && jQuery.ajax({
            url: "https://script.google.com/macros/s/AKfycbwXkJ6DaBxLI0Lz9nTypQuULMbFNo8NWTrnhHwUQXIGUO-PchjVFTI4oao2nxuKm_JprQ/exec",
            data: {
                Date_Time: today,
                Name: name,
                Email: email,
                Phone_Number: phoneNo,
                Description: describeTheApp,
                Targeted_Platforms: targetedPlatforms.toString(),
                Prefered_UI: preferUI,
                Number_Of_Screens: numberOfScreens,
                Upload_Feature: uploadFeature.toString(),
                Functionality: setOfFunctionality.toString(),
        ...
        t.preventDefault(), name = $("#name").val(), email = $("#email").val(), phoneNo = $("#phone").val(), message = $("#message").val(), reCaptcha = $("#img-captcha").val(), name && email && phoneNo && reCaptcha && jQuery.ajax({
            url: "https://script.google.com/macros/s/AKfycbwjBT4F4E454ZTDilrp0QMjijpXt63L5ikYqOZOK2VwtG7sYtlA42IMFUpY5Ct8__Trsg/exec",
            type: "POST",
            cache: !1,
            data: {
                Time: today,
    ...
    function o(t) {
        ...
        o <= n && i >= e && function(t) {
            t.hasClass("ms-animated") || (t.addClass("ms-animated"), t.prop("counter", 0).animate({
                ...
                easing: "linear",
                step: function() {
                    t.text(Math.floor(this.Counter))
                },
                complete: function() {
                    t.text(this.Counter)
                }
    ...
    e.on("click", function(t) {
        t.preventDefault(), name = $("#rname").val(), email = $("#remail").val(), reCaptcha = $("#img-captchaPopup").val(), name && email && reCaptcha && $.ajax({
